...
constexpr unsigned int kMaxNumOfRenderTargetHandle = 1024;
constexpr unsigned int kMaxNumOfDepthStencilHandle = 1024;
constexpr unsigned int kMaxNumOfTextureHandle = 1024;
